...
export default function RateFinderPage() {
  ...
  const [results, setResults] = useState<RateFinderResult | null>(null)
  ...
  const handleCalculate = async () => {
    try {
      ...
      fetch('/api/calculators/save', {
        ...
        body: JSON.stringify({
          calculator_type: 'rate-finder',
          inputs: { presentValue, futureValue, tenureYears },
          results: r,
          is_draft: true,
        }),
      }).catch(() => undefined)
      ...
      addToast('Error calculating required rate', 'error')
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-3">Rate Finder</h1>
        ...
        {results && (
          <div className="card p-8">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <Stat label="Required Annual Rate" value={`${results.requiredAnnualRate}%`} accent />
              <Stat label="Growth Multiplier" value={`${results.multiplier}×`} />
            </div>
